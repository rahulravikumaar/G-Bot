...
: ${AMENT_CURRENT_PREFIX:="/home/rahulravikumar/rover_ws/install/rover"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover/environment/pythonpath.sh"
